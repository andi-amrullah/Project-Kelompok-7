...
if (isset($_POST['simpan'])) {
  ...
  // update user data
  $result = mysqli_query($mysqli, "UPDATE tb_kembali SET id_pinjam = '$id_pinjam',no_induk ='$no_induk', nama ='$nama', no_telepon ='$no_telepon',
                          id_barang ='$id_barang', tgl_pinjam ='$tgl_pinjam', tgl_kembali = '$tgl_kembali', 
                          jenis_barang = '$jenis_barang', jml_kembali = '$jml_kembali' WHERE id_kembali = $id");

  // Redirect to homepage to display updated user in list
  header("Location:layoutAdmin.php?halaman=tableKembali");
}
?>
<?php
...
$result = mysqli_query($mysqli, "SELECT * FROM tb_kembali WHERE id_kembali = $id");
...
while ($user_data = mysqli_fetch_array($result)) {
  ...
  $jml_kembali = $user_data['jml_kembali'];
}
?>
    ...
    <div class="konten">
      <form class="form-horizontal" method="post">
        ...
        <div class="form-group">
          <label for="id_pinjam" class="col-sm-2 control-label">ID Pinjam</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" name="id_pinjam" value="<?php echo $id_pinjam; ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          <label for="jml_kembali" class="col-sm-2 control-label mt-3">Jumlah Pinjam</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" name="jml_kembali" value="<?php echo $jml_kembali; ?>">
          </div>
        </div>
